...
当天逐分钟采样 + 与 CBOE 快照逐字段核对：
    ...
    09:39 ET   长桥 OI 刷新到位，与 CBOE 当日快照一字不差
               GLD 9/18 400P  20,848 → 21,979（= CBOE 9/1 快照值）
               GLD 9/18 430C 128,754 → 127,535（= CBOE 9/1 快照值）

即盘前用长桥 OI 会差【整整一个交易日的建仓】，不是"稍旧"。
盘前的结构分析一律走 CBOE 快照；长桥 OI 只在开盘 10 分钟后可作交叉验证。
